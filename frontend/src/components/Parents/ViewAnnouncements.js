...
const ViewAnnouncements = () => {
  ...
  const fetchAnnouncements = async () => {
    try {
      ...
      const response = await fetch(`http://localhost:5000/school-admin/announcements/public?audience=parents&schoolId=${schoolId}`, {
        method: 'GET',
        headers: {
  ...
  return (
    <div style={styles.container}>
      <div style={styles.header}>
        ...
        <p style={{ color: '#64748b' }}>Stay updated with the latest news from your child's school</p>
      </div>
