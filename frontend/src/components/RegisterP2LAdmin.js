...
export default function RegisterP2LAdmin() {
  ...
  const handleSubmit = async () => {
    ...
    // Validation
    if (!formData.name || !formData.email || !formData.gender || !formData.dateOfBirth || !formData.password || !formData.adminSecret) {
    ...
    if (!formData.adminSecret.trim()) {
      setError('Admin secret is required to create a P2L Admin account');
      return;
    }
    ...
    <div style={styles.container}>
      <div style={styles.card}>
        <div style={styles.registerSection}>
          ...
          <h1 style={styles.title}>Admin Account</h1>
          ...
          <div>
            ...
            <div style={styles.formGroup}>
              <label style={styles.label}>
                Admin Secret<span style={styles.required}>*</span>
              </label>
              <input
                type="password"
                name="adminSecret"
            ...
            <button
              ...
              style={{
                ...
                boxShadow: buttonHovered && !loading ? '0 8px 20px rgba(239, 68, 68, 0.3)' : '0 0 0 rgba(239, 68, 68, 0)',
        ...
        <div style={styles.infoSection}>
          <h2 style={styles.infoTitle}>
            P2L Admin Privileges 👑
          </h2>

          <div>
            <div style={styles.feature}>
              <span style={styles.star}>🔒</span>
              <span>Full platform administrative access</span>
            </div>

            <div style={styles.feature}>
              <span style={styles.star}>🔒</span>
              <span>Manage all users and organizations</span>
            </div>
            ...
            <div style={styles.feature}>
              <span style={styles.star}>🔒</span>
              <span>Requires valid admin secret for registration</span>
            </div>
          </div>
        </div>
      </div>
