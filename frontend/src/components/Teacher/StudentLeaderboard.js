...
export default function StudentLeaderboard() {
  ...
  const displayClass = (studentClass) => {
    ...
    // If class is already a proper name (exists in myClasses), use it
    if (myClasses.includes(studentClass)) return studentClass;
    // If it looks like an ObjectId (24 hex chars), show first available class or 'Class'
  ...
  const styles = {
    ...
    podium: { display: 'flex', justifyContent: 'center', alignItems: 'flex-end', gap: '20px', marginBottom: '32px', padding: '20px', flexWrap: 'wrap' },
    ...
    <div style={styles.container}>
      <div style={styles.content}>
        ...
        {!error && leaderboard.length === 0 && (
          <div style={{ ...styles.tableBox, ...styles.empty }}>
          ...
          <div style={styles.podium}>
            {topThree[1] && (
              <div style={styles.podiumItem}>
                ...
                <div style={styles.podiumClass}>{displayClass(topThree[1].class)}</div>
            ...
            {topThree[0] && (
              <div style={{ ...styles.podiumItem, ...styles.podiumFirst }}>
                ...
                <div style={styles.podiumClass}>{displayClass(topThree[0].class)}</div>
            ...
            {topThree[2] && (
              <div style={styles.podiumItem}>
                ...
                <div style={styles.podiumClass}>{displayClass(topThree[2].class)}</div>
              ...
              <tbody>
                {leaderboard.map(s => (
                  <tr key={s._id}>
                    ...
                    <td style={styles.td}>{displayClass(s.class)}</td>
