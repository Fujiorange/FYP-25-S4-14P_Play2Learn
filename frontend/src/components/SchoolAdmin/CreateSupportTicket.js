// School Admin Create Support Ticket Component
...
export default function CreateSupportTicket() {
  ...
  const styles = {
    ...
    note: { padding: '16px', background: '#dbeafe', borderRadius: '8px', color: '#1e40af', fontSize: '14px', marginBottom: '20px' }
  };
    ...
    <div style={styles.container}>
      <div style={styles.content}>
        ...
        <div style={styles.note}>
          ℹ️ As a School Admin, you can create support tickets for <strong>website-related issues</strong> only. 
          These tickets will be sent to the P2L Admin team for assistance.
        </div>
